...
def change_wallpaper():
    ...
    urllib2.urlretrieve(photo, "C:/Users/vn/Downloads/a.png")
    image=os.path.join("C:/Users/vn/Downloads/a.png")
...
# In[219]:
def hi():
    speak("Tôi khỏe, chúc bạn một ngày vui vẻ")
...
def assistant():
    ...
    name = get_text()
    if name:
        speak("Chào bạn {}, Bạn cần giúp gì nhỉ?".format(name))
        ...
        while True:
            ...
            if not text:
                ...
                if 'mở google và tìm' in text:
                    open_google_and_search(text)
                elif "youtube" in text or "facebook" in text:
                    open_website(text)
                else:
                ...
                read_news()
            elif "khái niệm" in text:
                tell_me_about()
            elif "khỏe" in text:
                hi()
            elif "hello" in text or "chào" in text:
                hello(name)
            else:
